...
test('should return routes by menu location', t => {
  ...
  const a13 = ActionFactory.fromMenuLocation({ state: { menuLocation: 'blank-screen' } });
...
test('should return routes by route', t => {
  ...
  const a13 = ActionFactory.fromRoute({ route: 'blank-screen', user });
